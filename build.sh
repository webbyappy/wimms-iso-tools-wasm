...
sha1dgst.o \
ui-wit.o \
-o wit.js -s FORCE_FILESYSTEM=1 -s ALLOW_MEMORY_GROWTH=1 -s EXPORTED_FUNCTIONS='["_main"]' -s EXPORTED_RUNTIME_METHODS='["callMain","FS","WORKERFS"]' -s ENVIRONMENT=worker -s SYSCALL_DEBUG=0 -s STACK_SIZE=134217728 -s INITIAL_MEMORY=268435456 -s MAXIMUM_MEMORY=4294836224 -s MODULARIZE=1 -s EXPORT_NAME='WIT' -s ASSERTIONS=0 -s SAFE_HEAP=0 -lworkerfs.js -Wl,--allow-multiple-definition
